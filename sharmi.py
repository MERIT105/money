...
bot = telebot.TeleBot('8080745465:AAHFKkjaqQExz8NfCt-SwMvNqwnB79k3fxA') 

# -------------------------------
REQUIRED_CHANNELS = {
    "channel1": {
        "chat_id": "-1002678249799",  # अपना चैनल ID डालें
        "invite_link": "https://t.me/freebotalone"  # अपना इनवाइट लिंक
    },
    "channel2": {
        "chat_id": "-1002678249799",
        "invite_link": "https://t.me/freebotalone"
    }
}
...
def create_random_key():
    key = "SANJU-" + ''.join(random.choice(string.ascii_uppercase + string.digits) for _ in range(10))
    ...
    if len(details) == 3:
        ...
        try:
            ...
            if attack_time > MAX_ATTACK_TIME:
                ...
                full_command = f"./ipx {target} {port} {attack_time}"  # ✅ Correct variable name
